/* ============================================================================================================
   ...
   A modelagem já segue o T1 no schema:
   ...
   Como executar:
       cd p4_bd_schema_final_dados_csv/sql
...
/* ------------------------------------------------------------------------------------------------------------
   3. Mapeamento T1: nacionalidade textual dos CSVs -> país normalizado
   ------------------------------------------------------------------------------------------------------------
...
/* country_languages fica vazia nesta carga simplificada, pois não é usada no P4. */
